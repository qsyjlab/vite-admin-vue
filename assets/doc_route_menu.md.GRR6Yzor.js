import{_ as s,c as n,o as a,R as l}from"./chunks/framework.e2dboEyh.js";const h=JSON.parse('{"title":"菜单","description":"","frontmatter":{},"headers":[],"relativePath":"doc/route/menu.md","filePath":"doc/route/menu.md"}'),p={name:"doc/route/menu.md"},o=l(`<h1 id="菜单" tabindex="-1">菜单 <a class="header-anchor" href="#菜单" aria-label="Permalink to &quot;菜单&quot;">​</a></h1><h2 id="菜单配置" tabindex="-1">菜单配置 <a class="header-anchor" href="#菜单配置" aria-label="Permalink to &quot;菜单配置&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">  </span><span style="color:#6A737D;">// 排序</span></span>
