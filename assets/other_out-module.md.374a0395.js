import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.36267fc7.js";const F=JSON.parse('{"title":"外部模块引入","description":"","frontmatter":{},"headers":[],"relativePath":"other/out-module.md","filePath":"other/out-module.md"}'),l={name:"other/out-module.md"},o=p(`<h1 id="外部模块引入" tabindex="-1">外部模块引入 <a class="header-anchor" href="#外部模块引入" aria-label="Permalink to &quot;外部模块引入&quot;">​</a></h1><p>以安装 element-plus 为例</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">pnpm</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">i</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">element-plus</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">pnpm</span><span style="color:#24292E;"> </span><span style="color:#032F62;">i</span><span style="color:#24292E;"> </span><span style="color:#032F62;">element-plus</span></span></code></pre></div><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// src/plugins/elementPlus/index.ts</span></span>
